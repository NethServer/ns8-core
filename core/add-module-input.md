...
| :-------------------------------------- | :-------- | :------- | :------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [volumes](#volumes)                     | `object`  | Optional | cannot be null | [add-module input](add-module-input-properties-volumes.md "http://schema.nethserver.org/node/add-module-input.json#/properties/volumes")                           |
...
* Type: `object` ([Details](add-module-input-properties-volumes.md))

* cannot be null

* defined in: [add-module input](add-module-input-properties-volumes.md "http://schema.nethserver.org/node/add-module-input.json#/properties/volumes")
