...
* Type: an array of merged types ([IP address or CIDR](cluster-definitions-user-attributes-properties-allowed-networks-ip-address-or-cidr.md))
...
## Definitions group ipv6-cidr

Reference this group by using

```json
{"$ref":"http://schema.nethserver.org/cluster.json#/definitions/ipv6-cidr"}
```

| Property | Type | Required | Nullable | Defined by |
| :------- | :--- | :------- | :------- | :--------- |

## Definitions group ip-cidr

Reference this group by using

```json
{"$ref":"http://schema.nethserver.org/cluster.json#/definitions/ip-cidr"}
```
