...
| :-------- | :-------- | :------- | :------------- | :----------------------------------------------------------------------------------------------------------------------------------------- |
| [id](#id) | `integer` | Required | cannot be null | [run-backup input](run-backup-input-1-properties-backup-id.md "http://schema.nethserver.org/cluster/run-backup-input.json#/properties/id") |
...
* defined in: [run-backup input](run-backup-input-1-properties-backup-id.md "http://schema.nethserver.org/cluster/run-backup-input.json#/properties/id")
