...
import urllib.error
import base64
from .backup import probe_restic_gateway
...
def prepare_restic_command(rdb, repository, repo_path, podman_args, restic_args):
    ...
    gwaddress = probe_restic_gateway(rdb, repository, repo_path, http_auth=http_auth)
    try:
    ...
    restic_env = {
        ...
        "RESTIC_REPOSITORY": "rest:" + gwaddress + '/' + repo_path,
