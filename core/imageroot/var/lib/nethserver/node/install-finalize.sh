...
cluster.grants.grant(rdb, action_clause="add-port-forward",  to_clause="fwadm,portsadm", on_clause='node/1')
cluster.grants.grant(rdb, action_clause="remove-port-forward",  to_clause="fwadm,portsadm", on_clause='node/1')
