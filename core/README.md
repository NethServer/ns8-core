...
* [add-rclone-destination input](./add-rclone-destination-input.md "Input schema of the add-rclone-destination action") – `http://schema.nethserver.org/node/add-rclone-destination-input.json`
...
* [add-rich-rules input](./add-rich-rules-input.md "Add firewall rich rules") – `http://schema.nethserver.org/node/add-rich-rules-input.json`
...
* [import-backup-destinations input](./import-backup-destinations-input.md "Import backup destination configurations from raw cluster backup data") – `http://schema.nethserver.org/cluster/import-backup-destinations-input.json`

* [import-backup-destinations output](./import-backup-destinations-output.md "Import backup destination configurations from raw cluster backup data") – `http://schema.nethserver.org/cluster/import-backup-destinations-output.json`
...
* [list-cluster-backup-endpoints output](./list-cluster-backup-endpoints-output.md "Get the list of WebDAV backup endpoints provided by cluster nodes") – `http://schema.nethserver.org/cluster/list-cluster-backup-endpoints-output.json`
...
* [list-mountpoints output](./list-mountpoints.md "Output schema of the list-mountpoints action") – `http://schema.nethserver.org/node/list-mountpoints.json`

* [list-nodes output](./list-nodes.md "Output schema of the list-nodes action") – `http://schema.nethserver.org/cluster/list-nodes.json`
...
* [list-rich-rules output](./list-rich-rules-output.md "Output schema of the list-rich-rules action") – `http://schema.nethserver.org/node/list-rich-rules-output.json`
...
* [remove-rich-rules input](./remove-rich-rules-input.md "Remove firewall rich rules") – `http://schema.nethserver.org/node/remove-rich-rules-input.json`
...
* [run-backup input](./run-backup-input.md "Run the given backup immediately") – `http://schema.nethserver.org/node/run-backup-input.json`

* [run-backup input](./run-backup-input-1.md "Run the given backup immediately") – `http://schema.nethserver.org/cluster/run-backup-input.json`

* [set-automatic-updates](./set-automatic-updates-input.md "Configure the cluster-wide automatic updates switch and the per-instance automatic updates policy") – `http://schema.nethserver.org/cluster/set-automatic-updates-input.json`
...
* [set-note input](./set-note-input.md "A short note to help identify or describe a module instance") – `http://schema.nethserver.org/agent/set-note-input.json`
...
* [Rclone raw configuration](./add-backup-repository-input-defs-rclone-raw-configuration.md) – `http://schema.nethserver.org/cluster/add-backup-repository-input.json#/$defs/rclone_parameters`

* [Rclone raw configuration](./alter-backup-repository-input-defs-rclone-raw-configuration.md) – `http://schema.nethserver.org/cluster/alter-backup-repository-input.json#/$defs/rclone_parameters`
...
* [Untitled object in add-internal-provider input](./add-internal-provider-input-properties-volumes.md "Optional mapping of application volume names to filesystem mount points") – `http://schema.nethserver.org/cluster/add-internal-provider-input.json#/properties/volumes`

* [Untitled object in add-module input](./add-module-input-properties-volumes.md "Optional mapping of application volume names to filesystem mount points") – `http://schema.nethserver.org/node/add-module-input.json#/properties/volumes`

* [Untitled object in add-module input](./add-module-input-1-properties-volumes.md "Optional mapping of application volume names to filesystem mount points") – `http://schema.nethserver.org/cluster/add-module-input.json#/properties/volumes`

* [Untitled object in clone-module input](./clone-module-input-1-properties-volumes.md "Optional mapping of application volume names to filesystem mount points") – `http://schema.nethserver.org/cluster/clone-module-input.json#/properties/volumes`

* [Untitled object in create-module input](./create-module-input-properties-volumes.md "Optional mapping of application volume names to filesystem mount points") – `http://schema.nethserver.org/agent/create-module-input.json#/properties/volumes`
...
* [Untitled object in list-alerts output](./list-alerts-defs-alertmanager-v2-object-properties-status.md) – `http://schema.nethserver.org/cluster/list-alerts.json#/$defs/alertmanager-v2-object/properties/status`
...
* [Untitled object in list-cluster-backup-endpoints output](./list-cluster-backup-endpoints-output-properties-endpoints-items.md) – `http://schema.nethserver.org/cluster/list-cluster-backup-endpoints-output.json#/properties/endpoints/items`
...
* [Untitled object in list-mountpoints output](./list-mountpoints-defs-fsinfo.md) – `http://schema.nethserver.org/node/list-mountpoints.json#/$defs/fsinfo`
...
* [Untitled object in set-automatic-updates](./set-automatic-updates-input-properties-instances.md "Map of module instance IDs to their automatic updates policy") – `http://schema.nethserver.org/cluster/set-automatic-updates-input.json#/properties/instances`
...
* [Allowed networks](./cluster-definitions-user-attributes-properties-allowed-networks.md "List of IPv4/IPv6 addresses or CIDR networks the user is allowed to connect from") – `http://schema.nethserver.org/cluster.json#/definitions/user-attributes/properties/allowed_networks`
...
* [Untitled array in add-rich-rules input](./add-rich-rules-input-properties-rich_rules.md) – `http://schema.nethserver.org/node/add-rich-rules-input.json#/properties/rich_rules`
...
* [Untitled array in get-user-info output](./get-user-info-output-properties-allowed_networks.md "Array of IPv4/IPv6 addresses or CIDR networks the user is allowed to connect from") – `http://schema.nethserver.org/cluster/get-user-info-output.json#/properties/allowed_networks`
...
* [Untitled array in list-cluster-backup-endpoints output](./list-cluster-backup-endpoints-output-properties-endpoints.md) – `http://schema.nethserver.org/cluster/list-cluster-backup-endpoints-output.json#/properties/endpoints`
...
* [Untitled array in list-mountpoints output](./list-mountpoints-properties-mountpoints.md) – `http://schema.nethserver.org/node/list-mountpoints.json#/properties/mountpoints`
...
* [Untitled array in list-rich-rules output](./list-rich-rules-output-properties-rich_rules.md) – `http://schema.nethserver.org/node/list-rich-rules-output.json#/properties/rich_rules`
...
* [Untitled array in remove-rich-rules input](./remove-rich-rules-input-properties-rich_rules.md) – `http://schema.nethserver.org/node/remove-rich-rules-input.json#/properties/rich_rules`
