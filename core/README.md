...
* [disable-node-terminal input](./disable-node-terminal-input.md "Forbid the cluster-admin terminal on a node") – `http://schema.nethserver.org/cluster/disable-node-terminal-input.json`
...
* [enable-node-terminal input](./enable-node-terminal-input.md "Allow the cluster-admin terminal on a node") – `http://schema.nethserver.org/cluster/enable-node-terminal-input.json`
...
* [probe-terminal-access output](./probe-terminal-access-output.md "Whether sshd on this node accepts the cluster-admin terminal") – `http://schema.nethserver.org/node/probe-terminal-access-output.json`
