...
* [add-port-forward input](./add-port-forward-input.md "Add firewall configuration for a new port forward") – `http://schema.nethserver.org/node/add-port-forward-input.json`
...
* [remove-port-forward input](./remove-port-forward-input.md "Remove firewall configuration for a port forward") – `http://schema.nethserver.org/node/remove-port-forward-input.json`
...
* [Protocols](./add-port-forward-input-properties-protocols.md) – `http://schema.nethserver.org/node/add-port-forward-input.json#/properties/protocols`

* [Protocols](./remove-port-forward-input-properties-protocols.md) – `http://schema.nethserver.org/node/remove-port-forward-input.json#/properties/protocols`
