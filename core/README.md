...
* [deallocate-ports output](./deallocate-ports-output.md "Return an array with old ports range deallocated") – `http://schema.nethserver.org/node/deallocate-ports-output.json`
