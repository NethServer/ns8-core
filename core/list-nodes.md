...
| [terminal\_enabled](#terminal_enabled)                | `boolean`     | Optional | cannot be null | [list-nodes output](list-nodes-defs-node-info-properties-terminal_enabled.md "http://schema.nethserver.org/cluster/list-nodes.json#/$defs/node-info/properties/terminal_enabled")               |
...
Whether the cluster-admin terminal is allowed on this node
...
* defined in: [list-nodes output](list-nodes-defs-node-info-properties-terminal_enabled.md "http://schema.nethserver.org/cluster/list-nodes.json#/$defs/node-info/properties/terminal_enabled")

#### terminal\_enabled Type
