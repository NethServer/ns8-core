...
| :------------------ | :------- | :------- | :------------- | :------------------------------------------------------------------------------------------------------------------------------------------------- |
| [volumes](#volumes) | `object` | Optional | cannot be null | [create-module input](create-module-input-properties-volumes.md "http://schema.nethserver.org/agent/create-module-input.json#/properties/volumes") |
...
* Type: `object` ([Details](create-module-input-properties-volumes.md))

* cannot be null

* defined in: [create-module input](create-module-input-properties-volumes.md "http://schema.nethserver.org/agent/create-module-input.json#/properties/volumes")
