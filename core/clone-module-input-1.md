...
| :------------------ | :-------- | :------- | :------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [volumes](#volumes) | `object`  | Optional | cannot be null | [clone-module input](clone-module-input-1-properties-volumes.md "http://schema.nethserver.org/cluster/clone-module-input.json#/properties/volumes")      |
...
* Type: `object` ([Details](clone-module-input-1-properties-volumes.md))

* cannot be null

* defined in: [clone-module input](clone-module-input-1-properties-volumes.md "http://schema.nethserver.org/cluster/clone-module-input.json#/properties/volumes")
