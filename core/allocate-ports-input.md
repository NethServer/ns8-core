...
| :------------------------------- | :-------- | :------- | :------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ports](#ports)                  | `number`  | Required | cannot be null | [allocate-ports input](allocate-ports-input-properties-ports-number.md "http://schema.nethserver.org/node/allocate-ports-input.json#/properties/ports")                |
...
* Type: `number` ([Ports number](allocate-ports-input-properties-ports-number.md))

* cannot be null

* defined in: [allocate-ports input](allocate-ports-input-properties-ports-number.md "http://schema.nethserver.org/node/allocate-ports-input.json#/properties/ports")

### ports Type

`number` ([Ports number](allocate-ports-input-properties-ports-number.md))
