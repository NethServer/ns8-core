...
| :------------------------------------ | :-------- | :------- | :------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [volumes](#volumes)                   | `object`  | Optional | cannot be null | [add-module input](add-module-input-1-properties-volumes.md "http://schema.nethserver.org/cluster/add-module-input.json#/properties/volumes")                            |
...
| [module\_uuid](#module_uuid)          | `string`  | Optional | cannot be null | [add-module input](add-module-input-1-properties-module_uuid.md "http://schema.nethserver.org/cluster/add-module-input.json#/properties/module_uuid")                    |
...
* Type: `object` ([Details](add-module-input-1-properties-volumes.md))

* cannot be null

* defined in: [add-module input](add-module-input-1-properties-volumes.md "http://schema.nethserver.org/cluster/add-module-input.json#/properties/volumes")

### volumes Type

`object` ([Details](add-module-input-1-properties-volumes.md))
...
Used by clone and restore to set UUID in module's environment, instead of generating a new one.
...
* defined in: [add-module input](add-module-input-1-properties-module_uuid.md "http://schema.nethserver.org/cluster/add-module-input.json#/properties/module_uuid")
