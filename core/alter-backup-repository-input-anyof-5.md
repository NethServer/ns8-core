...
```txt
http://schema.nethserver.org/cluster/alter-backup-repository-input.json#/anyOf/5
```
...
merged type ([Details](alter-backup-repository-input-anyof-5.md))

all of

* [Safe values for parameters object](alter-backup-repository-input-defs-safe-values-for-parameters-object.md "check type definition")
