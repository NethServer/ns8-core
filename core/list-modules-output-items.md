...
| [apply\_updates\_is\_active](#apply_updates_is_active) | `boolean`     | Required | cannot be null | [list-modules output](list-modules-output-items-properties-apply_updates_is_active.md "http://schema.nethserver.org/cluster/list-modules-output.json#/items/properties/apply_updates_is_active") |
| [subscription\_is\_active](#subscription_is_active)    | `boolean`     | Required | cannot be null | [list-modules output](list-modules-output-items-properties-subscription_is_active.md "http://schema.nethserver.org/cluster/list-modules-output.json#/items/properties/subscription_is_active")   |
