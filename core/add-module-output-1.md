...
| [module\_uuid](#module_uuid) | `string` | Required | cannot be null | [add-module output](add-module-output-1-properties-module_uuid.md "http://schema.nethserver.org/cluster/add-module-output.json#/properties/module_uuid") |
...
* defined in: [add-module output](add-module-output-1-properties-module_uuid.md "http://schema.nethserver.org/cluster/add-module-output.json#/properties/module_uuid")
