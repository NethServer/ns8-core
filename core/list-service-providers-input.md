...
| [sortby](#sortby)       | `string` | Optional | cannot be null | [list-service-providers input](list-service-providers-input-properties-sorting-rule.md "http://schema.nethserver.org/agent/list-service-providers-input.json#/properties/sortby")          |
...
* Type: `string` ([Sorting rule](list-service-providers-input-properties-sorting-rule.md))

* cannot be null

* defined in: [list-service-providers input](list-service-providers-input-properties-sorting-rule.md "http://schema.nethserver.org/agent/list-service-providers-input.json#/properties/sortby")
