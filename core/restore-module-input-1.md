...
```json
{
  ...
  "path": "dokuwiki/f5d24fcd-819c-4b1d-98ad-a1b2ebcee8cf",
  "snapshot": "",
  "node": 1,
  "replace": false
}
...
| :------------------------ | :-------- | :------- | :------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [volumes](#volumes)       | `object`  | Optional | cannot be null | [restore-module input](restore-module-input-1-properties-volumes.md "http://schema.nethserver.org/cluster/restore-module-input.json#/properties/volumes")          |
...
* Type: `object` ([Details](restore-module-input-1-properties-volumes.md))

* cannot be null

* defined in: [restore-module input](restore-module-input-1-properties-volumes.md "http://schema.nethserver.org/cluster/restore-module-input.json#/properties/volumes")
