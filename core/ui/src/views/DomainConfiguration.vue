...
import EditPasswordWarning from "@/components/domains/EditPasswordWarningModal";
...
export default {
  ...
  methods: {
    ...
    validatePasswordWarning() {
      ...
      if (parseInt(this.policy.warning.days) < 1 || parseInt(this.policy.warning.days) > 1000) {
