...
```json
{
  "image": "ghcr.io/nethserver/samba:3.4.1",
  "node": 1,
...
| [volumes](#volumes) | `object`  | Optional | cannot be null | [add-internal-provider input](add-internal-provider-input-properties-volumes.md "http://schema.nethserver.org/cluster/add-internal-provider-input.json#/properties/volumes")        |
...
* Type: `object` ([Details](add-internal-provider-input-properties-volumes.md))

* cannot be null

* defined in: [add-internal-provider input](add-internal-provider-input-properties-volumes.md "http://schema.nethserver.org/cluster/add-internal-provider-input.json#/properties/volumes")
