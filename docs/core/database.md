...
|cluster/module_uuid                    |HASH       |Maps module_id to module UUID for service discovery and backup authorization. Clone/restore may create temporary UUID duplicates. |
